...
<head>
  ...
  <title>$SiteConfig.Title | Change password | devart admin interface</title>
            ...
            <div class="mt-6">
              <form $AttributesHTML class="space-y-6">
                <div>
                  ...
                  <div class="mt-1">
                    <input $Fields.fieldByName("NewPassword1").addExtraClass("text-gray-700 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-devart-teal focus:border-devart-teal sm:text-sm").AttributesHTML />
                  </div>
                </div>
                <div>
                  <label for="email" class="block text-sm font-medium text-gray-700">
                  ...
                  <div class="mt-1">
                    <input $Fields.fieldByName("NewPassword2").addExtraClass("text-gray-700 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-devart-teal focus:border-devart-teal sm:text-sm").AttributesHTML />
                  </div>
                </div>
